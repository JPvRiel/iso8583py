...
class ISO8583:
  ...
  _TMP = [0, _BIT_POSITION_8, _BIT_POSITION_1, _BIT_POSITION_2, _BIT_POSITION_3,
          _BIT_POSITION_4, _BIT_POSITION_5, _BIT_POSITION_6, _BIT_POSITION_7]
  _BIT_DEFAULT_VALUE = 0

  # Array to hold message definition
  _BITS_VALUE_TYPE = {}

  # ISO8583 content definitions according to version
  _VERSIONS = {1987, 1993, 2003}
  _VERSION = 0 	# 0 represents undefined / not set
  #_BITS_VALUE_TYPE = {}
  ...
  # K = type of values a, an, n, ansb, b

  ##########################################################################
  def setVersion(self, version):
    # Specify the version or type of the message
    """ This funciton allows a bulk re-definition of bit types and formats according to a specific version of the ISO8583 specificaiton.
        @param version: version (1987 or 1993 or 2003) -> should be specified as the integer matching the year of the ISO8583 version.
        @raise: ValueToLarge Exception
    """

    if version not in self._VERSIONS:
      raise InvalidVersion('Invalid ISO8583 version was specified as \'%d\'. Valid version parameters are %s.' % (
          version, self._VERSIONS))
      return

    if version == 2003:
      raise InvalidVersion(
          'Unsupported ISO8583 version was specified as \'%d\' Consider manually setting the ISO8583 bits with redefineBit().' % version)
      return

    # Universal BITS - data elements that should remain the same regardless of
    # version, e.g. 1, 64 and 128
    self._BITS_VALUE_TYPE[1] = ['BME', 'Bit Map Extended', 'B', 16, 'b']
    self._BITS_VALUE_TYPE[64] = [
        '64', 'Message authentication code (MAC) field', 'B', 16, 'b']
    self._BITS_VALUE_TYPE[128] = [
        '128', 'Message authentication code (MAC) field', 'B', 16, 'b']

    if version == 1987:
      # bit 1 universal accross versions
      self._BITS_VALUE_TYPE[2] = [
          '2', 'Primary account number (PAN)', 'LL', 19, 'n']
      self._BITS_VALUE_TYPE[3] = ['3', 'Precessing code', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[4] = ['4', 'Amount, transaction', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[5] = ['5', 'Amount, Settlement', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[6] = [
          '6', 'Amount, cardholder billing', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[7] = ['7', 'Transmission date & time', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[8] = [
          '8', 'Amount, Cardholder billing fee', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[9] = [
          '9', 'Conversion rate, Settlement', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[10] = [
          '10', 'Conversion rate, cardholder billing', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[11] = [
          '11', 'Systems trace audit number', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[12] = ['12', 'Time, Local transaction', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[13] = ['13', 'Date, Local transaction', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[14] = ['14', 'Date, Expiration', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[15] = ['15', 'Date, Settlement', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[16] = ['16', 'Date, conversion', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[17] = ['17', 'Date, capture', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[18] = ['18', 'Merchant type', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[19] = [
          '19', 'Acquiring institution country code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[20] = [
          '20', 'PAN Extended, country code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[21] = [
          '21', 'Forwarding institution, country code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[22] = [
          '22', 'Point of service entry mode', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[23] = ['23', 'Application PAN number', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[24] = [
          '24', 'Network International identifier', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[25] = [
          '25', 'Point of service condition code', 'N', 2, 'n']
      self._BITS_VALUE_TYPE[26] = [
          '26', 'Point of service capture code', 'N', 2, 'n']
      self._BITS_VALUE_TYPE[27] = [
          '27', 'Authorising identification response length', 'N', 1, 'n']
      self._BITS_VALUE_TYPE[28] = ['28', 'Amount, transaction fee', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[29] = ['29', 'Amount, settlement fee', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[30] = [
          '30', 'Amount, transaction processing fee', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[31] = [
          '31', 'Amount, settlement processing fee', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[32] = [
          '32', 'Acquiring institution identification code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[33] = [
          '33', 'Forwarding institution identofication code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[34] = [
          '34', 'Primary account number, extended', 'LL', 28, 'n']
      self._BITS_VALUE_TYPE[35] = ['35', 'Track 2 data', 'LL', 37, 'b']
      self._BITS_VALUE_TYPE[36] = ['36', 'Track 3 data', 'LLL', 104, 'n']
      self._BITS_VALUE_TYPE[37] = [
          '37', 'Retrieval reference number', 'AN', 12, 'an']
      self._BITS_VALUE_TYPE[38] = [
          '38', 'Authorisation identification response', 'AN', 6, 'an']
      self._BITS_VALUE_TYPE[39] = ['39', 'Response code', 'AN', 2, 'an']
      self._BITS_VALUE_TYPE[40] = [
          '40', 'Service restriction code', 'AN', 3, 'an']
      self._BITS_VALUE_TYPE[41] = [
          '41', 'Card acceptor terminal identification', 'ANS', 8, 'ans']
      self._BITS_VALUE_TYPE[42] = [
          '42', 'Card acceptor identification code', 'ANS', 15, 'ans']
      self._BITS_VALUE_TYPE[43] = [
          '43', 'Card acceptor name/location', 'ANS', 40, 'ans']
      self._BITS_VALUE_TYPE[44] = [
          '44', 'Additional response data', 'LL', 25, 'an']
      self._BITS_VALUE_TYPE[45] = ['45', 'Track 1 Data', 'LL', 76, 'an']
      self._BITS_VALUE_TYPE[46] = [
          '46', 'Additional data - ISO', 'LLL', 999, 'an']
      self._BITS_VALUE_TYPE[47] = [
          '47', 'Additional data - National', 'LLL', 999, 'an']
      self._BITS_VALUE_TYPE[48] = [
          '48', 'Additional data - Private', 'LLL', 999, 'an']
      self._BITS_VALUE_TYPE[49] = [
          '49', 'Currency code, transaction', 'A', 3, 'a']
      self._BITS_VALUE_TYPE[50] = [
          '50', 'Currency code, settlement', 'AN', 3, 'an']
      self._BITS_VALUE_TYPE[51] = [
          '51', 'Currency code, cardholder billing', 'A', 3, 'a']
      self._BITS_VALUE_TYPE[52] = [
          '52', 'Personal Identification number data', 'B', 16, 'b']
      self._BITS_VALUE_TYPE[53] = [
          '53', 'Security related control information', 'B', 18, 'b']
      self._BITS_VALUE_TYPE[54] = ['54', 'Additional amounts', 'LLL', 120, 'an']
      self._BITS_VALUE_TYPE[55] = ['55', 'Reserved ISO', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[56] = ['56', 'Reserved ISO', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[57] = ['57', 'Reserved National', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[58] = ['58', 'Reserved National', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[59] = [
          '59', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[60] = [
          '60', 'Advice/reason code (private reserved)', 'L', 7, 'an']
      self._BITS_VALUE_TYPE[61] = ['61', 'Reserved Private', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[62] = ['62', 'Reserved Private', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[63] = ['63', 'Reserved Private', 'LLL', 999, 'ans']
      # bit 64 universal accross versions
      self._BITS_VALUE_TYPE[65] = ['65', 'Bit map, tertiary', 'B', 16, 'b']
      self._BITS_VALUE_TYPE[66] = ['66', 'Settlement code', 'N', 1, 'n']
      self._BITS_VALUE_TYPE[67] = ['67', 'Extended payment code', 'N', 2, 'n']
      self._BITS_VALUE_TYPE[68] = [
          '68', 'Receiving institution country code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[69] = [
          '69', 'Settlement institution county code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[70] = [
          '70', 'Network management Information code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[71] = ['71', 'Message number', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[72] = ['72', 'Message number, last', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[73] = ['73', 'Date, Action', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[74] = ['74', 'Credits, number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[75] = [
          '75', 'Credits, reversal number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[76] = ['76', 'Debits, number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[77] = [
          '77', 'Debits, reversal number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[78] = ['78', 'Transfer number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[79] = [
          '79', 'Transfer, reversal number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[80] = ['80', 'Inquiries number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[81] = ['81', 'Authorisations, number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[82] = [
          '82', 'Credits, processsing fee amount', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[83] = [
          '83', 'Credits, transaction fee amount', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[84] = [
          '84', 'Debits, processing fee amount', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[85] = [
          '85', 'Debits, transaction fee amount', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[86] = ['86', 'Credits, amount', 'N', 15, 'n']
      self._BITS_VALUE_TYPE[87] = [
          '87', 'Credits, reversal amount', 'N', 15, 'n']
      self._BITS_VALUE_TYPE[88] = ['88', 'Debits, amount', 'N', 15, 'n']
      self._BITS_VALUE_TYPE[89] = [
          '89', 'Debits, reversal amount', 'N', 15, 'n']
      self._BITS_VALUE_TYPE[90] = ['90', 'Original data elements', 'N', 42, 'n']
      self._BITS_VALUE_TYPE[91] = ['91', 'File update code', 'AN', 1, 'an']
      self._BITS_VALUE_TYPE[92] = ['92', 'File security code', 'N', 2, 'n']
      self._BITS_VALUE_TYPE[93] = ['93', 'Response indicator', 'N', 5, 'n']
      self._BITS_VALUE_TYPE[94] = ['94', 'Service indicator', 'AN', 7, 'an']
      self._BITS_VALUE_TYPE[95] = ['95', 'Replacement amounts', 'AN', 42, 'an']
      self._BITS_VALUE_TYPE[96] = ['96', 'Message security code', 'AN', 8, 'an']
      self._BITS_VALUE_TYPE[97] = ['97', 'Amount, net settlement', 'N', 16, 'n']
      self._BITS_VALUE_TYPE[98] = ['98', 'Payee', 'ANS', 25, 'ans']
      self._BITS_VALUE_TYPE[99] = [
          '99', 'Settlement institution identification code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[100] = [
          '100', 'Receiving institution identification code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[101] = ['101', 'File name', 'ANS', 17, 'ans']
      self._BITS_VALUE_TYPE[102] = [
          '102', 'Account identification 1', 'LL', 28, 'ans']
      self._BITS_VALUE_TYPE[103] = [
          '103', 'Account identification 2', 'LL', 28, 'ans']
      self._BITS_VALUE_TYPE[104] = [
          '104', 'Transaction description', 'LL', 100, 'ans']
      self._BITS_VALUE_TYPE[105] = [
          '105', 'Reserved for ISO use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[106] = [
          '106', 'Reserved for ISO use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[107] = [
          '107', 'Reserved for ISO use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[108] = [
          '108', 'Reserved for ISO use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[109] = [
          '109', 'Reserved for ISO use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[110] = [
          '110', 'Reserved for ISO use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[111] = [
          '111', 'Reserved for ISO use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[112] = [
          '112', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[113] = [
          '113', 'Authorising agent institution id code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[114] = [
          '114', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[115] = [
          '115', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[116] = [
          '116', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[117] = [
          '117', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[118] = [
          '118', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[119] = [
          '119', 'Reserved for national use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[120] = [
          '120', 'Reserved for private use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[121] = [
          '121', 'Reserved for private use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[122] = [
          '122', 'Reserved for private use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[123] = [
          '123', 'Reserved for private use', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[124] = ['124', 'Info Text', 'LLL', 255, 'ans']
      self._BITS_VALUE_TYPE[125] = [
          '125', 'Network management information', 'LLL', 50, 'ans']
      self._BITS_VALUE_TYPE[126] = ['126', 'Issuer trace id', 'LLL', 6, 'ans']
      self._BITS_VALUE_TYPE[127] = [
          '127', 'Reserved for private use', 'LLL', 999, 'ans']
      # bit 128 universal accross versions

    if version == 1993:
      # bit 1 universal accross versions
      # Based on BASE24 ISO8583 1993 Spec Doc
      self._BITS_VALUE_TYPE[2] = [
          '2', 'Primary Account Number (PAN)', 'LL', 19, 'n']
      self._BITS_VALUE_TYPE[3] = ['3', 'Processing Code', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[4] = ['4', 'Amount, Transaction', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[5] = ['5', 'Amount, Settlement', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[6] = [
          '6', 'Amount, Cardholder Billing', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[7] = [
      ...
      self._BITS_VALUE_TYPE[11] = [
          '11', 'Systems trace audit number', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[12] = [
          '12', 'Date and Time, Local transaction', 'N', 12, 'n']
      self._BITS_VALUE_TYPE[13] = ['13', 'Date, Effective', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[14] = ['14', 'Date, Expiration', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[15] = ['15', 'Date, Settlement', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[16] = ['16', 'Date, conversion', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[17] = ['17', 'Date, capture', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[18] = ['18', 'Merchant type', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[19] = [
      ...
      self._BITS_VALUE_TYPE[21] = [
          '21', 'Forwarding institution, country code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[22] = [
          '22', 'Point of service data code', 'AN', 12, 'an']
      self._BITS_VALUE_TYPE[23] = ['23', 'Application PAN number', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[24] = ['24', 'Funciton code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[25] = ['25', 'Message reason code', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[26] = [
          '26', 'Card acceptor business code', 'N', 4, 'n']
      self._BITS_VALUE_TYPE[27] = [
          '27', 'Authorising identification response length', 'N', 1, 'n']
      self._BITS_VALUE_TYPE[28] = ['28', 'Date, Reconciliation', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[29] = [
          '29', 'Reconciliation Indicator', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[30] = ['30', 'Amounts, original', 'N', 24, 'n']
      self._BITS_VALUE_TYPE[31] = [
          '31', 'Acquirer reference number', 'N', 48, 'n']
      self._BITS_VALUE_TYPE[32] = [
          '32', 'Acquiring institution identification code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[33] = [
          '33', 'Forwarding institution identofication code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[34] = [
          '34', 'Primary account number, extended', 'LL', 28, 'n']
      self._BITS_VALUE_TYPE[35] = ['35', 'Track 2 data', 'LL', 37, 'b']
      self._BITS_VALUE_TYPE[36] = ['36', 'Track 3 data', 'LLL', 104, 'b']
      self._BITS_VALUE_TYPE[37] = [
          '37', 'Retrieval reference number', 'AN', 12, 'an']
      self._BITS_VALUE_TYPE[38] = [
          '38', 'Authorisation identification response', 'AN', 6, 'an']
      self._BITS_VALUE_TYPE[39] = ['39', 'Action code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[40] = [
          '40', 'Service restriction code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[41] = [
          '41', 'Card acceptor terminal identification', 'ANS', 16, 'ans']
      self._BITS_VALUE_TYPE[42] = [
          '42', 'Card acceptor identification code', 'ANS', 15, 'ans']
      self._BITS_VALUE_TYPE[43] = [
          '43', 'Card acceptor name/location', 'LL', 99, 'ans']
      self._BITS_VALUE_TYPE[44] = [
          '44', 'Additional response data', 'LL', 99, 'ans']
      self._BITS_VALUE_TYPE[45] = ['45', 'Track 1 Data', 'LL', 76, 'ans']
      self._BITS_VALUE_TYPE[46] = ['46', 'Amounts, Fees', 'LLL', 204, 'ans']
      self._BITS_VALUE_TYPE[47] = [
          '47', 'Additional data - National', 'LLL', 999, 'an']
      self._BITS_VALUE_TYPE[48] = [
          '48', 'Additional data - Private', 'LLL', 999, 'an']
      self._BITS_VALUE_TYPE[49] = [
          '49', 'Currency code, transaction', 'AN', 3, 'an']
      self._BITS_VALUE_TYPE[50] = [
          '50', 'Currency code, settlement', 'AN', 3, 'an']
      self._BITS_VALUE_TYPE[51] = [
          '51', 'Currency code, cardholder billing', 'AN', 3, 'an']
      self._BITS_VALUE_TYPE[52] = [
          '52', 'Personal Identification number data', 'AN', 16, 'an']
      self._BITS_VALUE_TYPE[53] = [
          '53', 'Security related control information', 'B', 18, 'b']
      self._BITS_VALUE_TYPE[54] = [
          '54', 'Additional amounts', 'LLL', 120, 'ans']
      self._BITS_VALUE_TYPE[55] = [
          '55', 'Integrated Circuit Card System Related Data Data Element', 'LLL', 510, 'ans']
      self._BITS_VALUE_TYPE[56] = [
          '56', 'Original Data Elements', 'LL', 35, 'n']
      self._BITS_VALUE_TYPE[57] = [
          '57', 'Authorisation Lifecycle Code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[58] = [
          '58', 'Authorizing Agent Institution ID Code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[59] = ['59', 'Transport Data', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[60] = ['60', 'CSM Reserved', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[61] = ['61', 'Reserved Private', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[62] = ['62', 'Reserved Private', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[63] = ['63', 'Reserved Private', 'LLL', 999, 'ans']
      # bit 64 universal accross versions
      ...
      self._BITS_VALUE_TYPE[69] = [
          '69', 'Settlement institution county code', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[70] = [
          '70', 'Country Code, Authorizing Agent Institution', 'N', 3, 'n']
      self._BITS_VALUE_TYPE[71] = ['71', 'Message number', 'N', 8, 'n']
      self._BITS_VALUE_TYPE[72] = ['72', 'Data Record', 'LLL', 999, 'ans']
      self._BITS_VALUE_TYPE[73] = ['73', 'Date, Action', 'N', 6, 'n']
      self._BITS_VALUE_TYPE[74] = ['74', 'Credits, number', 'N', 10, 'n']
      self._BITS_VALUE_TYPE[75] = [
          '75', 'Credits, reversal number', 'N', 10, 'n']
      ...
      self._BITS_VALUE_TYPE[91] = ['91', 'File update code', 'AN', 1, 'an']
      self._BITS_VALUE_TYPE[92] = ['92', 'File security code', 'N', 2, 'n']
      self._BITS_VALUE_TYPE[93] = [
          '93', ' Transaction Destination Institution Identification Code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[94] = [
          '94', ' Transaction Originator Institution Identification Code', 'LL', 11, 'n']
      self._BITS_VALUE_TYPE[95] = ['95', 'Replacement amounts', 'AN', 42, 'an']
      self._BITS_VALUE_TYPE[96] = ['96', 'Key Managment Data', 'LL', 99, 'an']
      # Key Managment Data is a very complex field as it's length depends on the tags contained within
      # Currently, this lib does not handle a field with a variable length definition and this bit will
      # presumably cause a parsing problem
      self._BITS_VALUE_TYPE[97] = ['97', 'Amount, net settlement', 'N', 16, 'n']
      self._BITS_VALUE_TYPE[98] = ['98', 'Payee', 'ANS', 25, 'ans']
      self._BITS_VALUE_TYPE[99] = [
          '99', 'Settlement institution identification code', 'LL', 11, 'n']
      ...
      self._BITS_VALUE_TYPE[126] = ['126', 'Issuer trace ID', 'LLL', 6, 'ans']
      self._BITS_VALUE_TYPE[127] = [
          '127', 'Reserved for private use', 'LLL', 9999, 'ans']
      # bit 128 universal accross versions
  ...
  def __init__(self, iso="", version=1993, debug=False):
    ...
    Example: To set a specific version you can use:
        pack = ISO8583(version=1987)
    @param: iso a String that represents the ASCII of the package. The same that you need to pass to setIsoContent() method.
    @param: version (1987 or 1993) default 1993 -> Used to define the set of data elements (bit) type, format and lengths
  ...
  def setBit(self, bit, value):
    ...
    # fixed length bit types
    if self.getBitType(bit) == 'N':
      self.__setBitTypeN(bit, value)
    elif self.getBitType(bit) == 'A':
      self.__setBitTypeA(bit, value)
    elif self.getBitType(bit) == 'AN':
      self.__setBitTypeAN(bit, value)
    elif self.getBitType(bit) == 'ANS':
      self.__setBitTypeANS(bit, value)
    elif self.getBitType(bit) == 'B':
      self.__setBitTypeB(bit, value)
    # variable length bit types
    elif self.getBitType(bit) == 'LL':
      self.__setBitTypeLL(bit, value)
    elif self.getBitType(bit) == 'LLL':
      self.__setBitTypeLLL(bit, value)
    elif self.getBitType(bit) == 'LLLL':
      self.__setBitTypeLLLL(bit, value)
    else:
      raise InvalidBitType("Error bit %d cannot be set because %s was not understood as a valid bitType (Hex, N, AN, ANS, LL, LLL, LLLL). Somehow, an incorrect bit type must have been set!" % (
          bit, self.getBitType(bit)))
  ...
  def __setBitTypeLLLL(self, bit, value):
    ...
    It put the size in front of the value
    Example: pack.setBit(127,'1000ABCDEFG') -> Bit 127 is a LLLL type, so this bit, in ASCII form need to be 1000ABCDEFG...
        To understand, 1000 is the size of the information and ABCD... is the information/value
    @param: bit -> bit to be setted
    @param: value -> value to be setted
    @raise: ValueToLarge Exception
    It's a internal method, so don't call!
  ...
  def __setBitTypeN(self, bit, value):
    ...
    It complete the size of the bit with a default value. Fixed numeric bit types must be right justified with leading zeros on left.
  ...
  def __setBitTypeA(self, bit, value):
    ...
    Complete the size of the fixed bit with a default value. Typically, fixed non-numeric bit types must be left justfified with spaces filled on the right.
    Example: pack.setBit(43,"Johannesburg") -> Bit 43 is A type, so this bit, in ASCII form needs to have a fixed size = 40 (ISO especification). The value "Johannesburg" is only 12 characters and must be expended to 40 with spaces
    @param: bit -> bit to be setted
    @param: value -> value to be setted
    @raise: ValueToLarge Exception
    It's a internal method, so don't call!
  ...
  def __setBitTypeAN(self, bit, value):
    ...
    Complete the size of the fixed bit with a default value. Typically, fixed non-numeric bit types must be left justfified with spaces filled on the right.
    Example: pack.setBit(22,'3000C') -> Bit 22 is a AN type of length 12, so this bit, in ASCII form need to has size = 12 (ISO especification).
        The value 3000C size = 5 need to receive more spaces to the right to fill the data element (bit) to 12 characters.
        In the package, the bit will be sent like '3000C       '
    @param: bit -> bit to be setted
    @param: value -> value to be setted
    @raise: ValueToLarge Exception
    It's a internal method, so don't call!
  ...
  ##########################################################################
  # Set of type Z
  def __setBitTypeZ(self, bit, value):
    """Method that set a bit with value in form Z (track 2 and track 3 special data formats)
    It complete the size of the bit with a default value
    Track 2 exluding starting and ending sentinel and longitudanl redundancy check (LRC) characters
    Examples:
    Track 2
        On card : ";1234567890123445=99011200XXXX00000000?*"
                ^^               ^^   ^   ^           ^^
                ||_ Card number  ||   |   |_ Encrypted||_ LRC
                |_ Start sentinel||   |      PIN***   |_ End sentinel
                                 ||   |_ Service code
                Field separator _||_ Expiration
        On ISO8583 Message bit 35 : "1234567890123445=99011X10XXXXXXX00000"
    Track 3 :
        On card : ";011234567890123445=724724100000000000030300XXXX040400099010=************************==1=0000000000000000?*"
                ^^ ^               ^^  ^  ^            ^ ^  ^   ^^ ^   ^    ^^                       ^^^^^               ^^
    ...
    # TODO, Z is a special format and zfill (zero fill) may not be an
    # approriate way to fill the field
    self.BITMAP_VALUES[bit] = value.zfill(self.getBitLimit(bit))
    ...
    for cont in range(0, 129):
      if self.BITMAP_VALUES[cont] != self._BIT_DEFAULT_VALUE:
        print("Bit[%s] of type %s has limit %s = %s" % (cont, self.getBitType(
            cont), self.getBitLimit(cont), self.BITMAP_VALUES[cont]))
  ...
  def redefineBit(self, bit, smallStr, largeStr, bitType, size, valueType):
    ...
    @param: bitType -> type the bit, used to build the values, example "LL" for bit 2. Need to be one of (B, N, AN, ANS, LL, LLL, LLLL)
    ...
    @param: valueType -> value type the bit, used to "validate" the values, example "n" for bit 2. This mean that in bit 2 we need to have only numeric values.
        Need to be one of (a, n, b, an, ans, ansb)
    ...
    if bit == 1 or bit == 64 or bit < 0 or bit > 128:
      raise BitInexistent(
          "Error %d cannot be changed because has a invalid bit number for ISO8583 data elements that should not be redefined!" % bit)

    # need to validate if the type and size is compatible! example slimit =
    # 100 and type = LL

    if bitType == "B" or bitType == "N" or bitType == "AN" or bitType == "ANS" or bitType == "LL" or bitType == "LLL" or bitType == "LLLL":
      if valueType == "a" or valueType == "n" or valueType == "b" or valueType == "an" or valueType == "ans" or valueType == "ansb" or valueType == "z":
        ...
        raise InvalidValueType(
            "Error bit %d cannot be changed because %s is not a valid valueType (a, n, b, an, ans, ansb)!" % (bit, valueType))
        # return
    else:
      raise InvalidBitType(
          "Error bit %d cannot be changed because %s is not a valid bitType (Hex, N, AN, ANS, LL, LLL, LLLL)!" % (bit, bitType))
      # return
  ...
  def __getBitFromStr(self, strWithoutMtiBitmap):
    ...
    offset = 0
    # jump bit 1 because it was alread defined in the
    # "__inicializeBitsFromBitmapStr"
      ...
      if self.BITMAP_VALUES[cont] != self._BIT_DEFAULT_VALUE:
        ...
        if self.getBitType(cont) == 'LL':
          ...
          self.BITMAP_VALUES[cont] = strWithoutMtiBitmap[
              offset:offset + 2] + strWithoutMtiBitmap[offset + 2:offset + 2 + valueSize]
        ...
        if self.getBitType(cont) == 'LLL':
          ...
          if valueSize > self.getBitLimit(cont):
            raise ValueToLarge("This bit is larger than the especification!")
          self.BITMAP_VALUES[cont] = strWithoutMtiBitmap[
              offset:offset + 3] + strWithoutMtiBitmap[offset + 3:offset + 3 + valueSize]
  ...
  def isBitSet(self, bit):
    """Return boolean to indicate wheather a bit is set
        @param: bit -> the number of the bit that you want to validate if it's set (used).
        @raise: BitInexistent Exception
    """

    if bit < 1 or bit > 128:
      raise BitInexistent("Bit number %s dosen't exist!" % bit)

    bitsPresentArray = self.__getBitsFromBitmap()

    if self.DEBUG == True:
      print('This is the array of bits inside the bitmap %s' % bitsPresentArray)

    if bit in bitsPresentArray:
      return True
    else:
      return False
  ...
  ##########################################################################
  # Method that will return a raw bit value within the iso package
  def getBit(self, bit):
    """Return the raw value of the bit, or None if bit doesn't exit (also raises BitNotSet Exception)
    ...
    if self.isBitSet(bit):
      if self.DEBUG == True:
        print('The raw value of the bit requested is \'%s\'' %
              self.BITMAP_VALUES[bit])
      return self.BITMAP_VALUES[bit]
    else:
  ...
  ##########################################################################
  # Method that will return a 'clean' bit value within the iso package,
  # stripping off any variable encoding in front of the bit
  def getBitValue(self, bit):
    """Return the 'clean' value of the bit with variable length bit encoding stripped out, or return None if bit doesn't exit (also raises BitNotSet Exception)
    @param: bit -> the number of the bit that you want the value.
    @raise: BitInexistent Exception, BitNotSet Exception
    """
    ...
    if self.isBitSet(bit):
      ...
      if bitType == 'LL':
        value = self.BITMAP_VALUES[bit][2:]
      elif bitType == 'LLL':
        value = self.BITMAP_VALUES[bit][3:]
      elif bitType == 'LLLL':
        value = self.BITMAP_VALUES[bit][4:]
      else:
        # assume fixed
        value = self.BITMAP_VALUES[bit]
      if self.DEBUG == True:
        print('The clean value of the bit requested is \'%s\'' % value)
      return value
    else:
      raise BitNotSet("Bit number %s was not set!" % bit)
  ...
  ##########################################################################
  # Method that will return the raw size of a bit value within the iso package
  def getBitLength(self, bit):
    """Return the raw length of the bit, or None if bit doesn't exit (also raises BitNotSet Exception)
    @param: bit -> the number of the bit that you want the value.
    @raise: BitInexistent Exception, BitNotSet Exception
    """
    ...
    if self.isBitSet(bit):
      if self.DEBUG == True:
        print('The length of the bit inspected is \'%s\' characters (inclusive of any variable bit size header) and the value is \'%s\'' % (
            len(self.BITMAP_VALUES[bit]), self.BITMAP_VALUES[bit]))
      return len(self.BITMAP_VALUES[bit])
    else:
      raise BitNotSet("Bit number %s was not set!" % bit)
  ...
  ##########################################################################
  # Method that will return the size of a bit value within the iso package
  def getBitValueLength(self, bit):
    """Return the clean length of the bit, or None if bit doesn't exit (also raises BitNotSet Exception)
    @param: bit -> the number of the bit that you want the value.
    @raise: BitInexistent Exception, BitNotSet Exception
    """
    ...
    if self.isBitSet(bit):
      if self.DEBUG == True:
        print('The length of the bits value is \'%s\' characters (excluding any variable size header) and the value is \'%s\'' % (
            len(self.getBitValue(bit)), getBitValue(bit)))
      return len(self.getBitValue(bit))
    else:
      raise BitNotSet("Bit number %s was not set!" % bit)
  ...
  ##########################################################################
  # Method that return ISO8583 to TCPIP network form, with the size in the
  # beginning.
  ...
  ##########################################################################
  # Method that recieve a ISO8583 ASCII package in the network form and
  # parse it.
